module.exports = function() {
    ...
    var create = function(callback) {
        ...
        */
        ...
        player.twitter.__request('post', '/oauth/request_token', function(res) {
           console.log('RES', res);
        });
        console.log('TWITTER', player.twitter);
            ...
            try
            {
                ...
                var OAuth = require('oauth').OAuth
                    , oauth = new OAuth(
                        ...
                        "1.0",
                        TWITTER_CALLBACK_URL + '?playerId=' + player.id + '&playerHash=' + player.hash + '&oauth=complete', //TODO CHANGE
                        "HMAC-SHA1"
                    );
