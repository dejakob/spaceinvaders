...
describe('Hawk', function () {
    ...
    describe('#getBewit', function () {
        ...
        it('errors on invalid credentials (id)', function (done) {
            ...
            var bewit = Hawk.uri.getBewit('https://example.com/somewhere/over/the/rainbow', { credentials: credentials, ttlSec: 80, ext: 'xandyandz' });
            expect(bewit).to.equal('');
            done();
        });
        ...
        it('errors on missing credentials', function (done) {
            ...
            var bewit = Hawk.uri.getBewit('https://example.com/somewhere/over/the/rainbow', { ttlSec: 80, ext: 'xandyandz' });
            expect(bewit).to.equal('');
            done();
        });
